...
const dblgAddress = "0xBb3bE04b045D7fCe45866667355Dc0Bb4F2d49Fd";
...
const MainMint = ({accounts, setAccounts}) =>{
    ...
    return (
        ...
        <Flex justify="center" align="center" height="100vh" paddingBottom="150px">
            <Box width="520px">
            <div>
                <Text fontSize="48px" textShadow="0 5px #000000">Dblgcol NFT</Text>
                <Text
                fontSize="30px"
                letterSpacing="-5.5%"
                fontFamily="VT323"
                ...
                >It's 2023. Each mint costs 0.005 ETH.</Text>
            </div>
            {isConnected ? (
